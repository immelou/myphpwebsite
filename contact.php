        ...
        <main class="main-section">
            <section class="sections img-left">
                <div class="info-container">
                    ...
                    [gravityform id=1 name=ContactForm title=false description=false]<br>
                    <p>
                    * This contact form was developed with a third party plugin called 
                    Gravity Forms and is not included in the Genesis Framework. It is 
                    for display on this demo site–though we highly recommend using it.
                    </p>
